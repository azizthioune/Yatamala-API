...
class Projet(models.Model):
    ...
    # date_approb = models.CharField(max_length=500, blank=True, default="")
    # date_vigueur = models.CharField(max_length=500, blank=True, default="")
    # date_cloture = models.CharField(max_length=500, blank=True, default="")
    # date_remb = models.CharField(max_length=500, blank=True, default="")
...
class Indicateur(models.Model):
    ...
    projet = models.ForeignKey(
        Projet, related_name="indicateurs", db_column='id_projet', on_delete=models.CASCADE)
    code = models.CharField(max_length=200, unique=True, blank=False)
